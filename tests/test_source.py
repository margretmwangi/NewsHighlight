...
class TestArticles(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_article = Articles('BBC', 'Maggie', 'The business graph in Africa.','A look at various businesses in Africa .','business.com','business.com/7643t94.jpg','2018-04-11T07:57:16Z')
    ...
    def test_to_check_instance_variables(self):
        ...
        self.assertEquals(self.new_article.author,'Maggie')
